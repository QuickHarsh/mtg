...
import { ScrollTriggeredCard } from '../components/ui/scroll-triggered-card';
import { productCategories, sustainabilityCertifications, howItWorksSteps } from '../data/mockData';
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {productCategories.map((category, idx) => (
              <ScrollTriggeredCard key={category.id} product={category} index={idx} />
            ))}
          </div>
            ...
            {howItWorksSteps.map((step, idx) => (
              ...
              >
                ...
                >
                  ...
                  >
                    <motion.img
                      src={`https://images.unsplash.com/photo-${idx === 0 ? '1573496359142-b89e5e5eadb8' :
                    ...
                    <motion.div
                      ...
                      viewport={{ once: true }}
                      transition={{
                        default: { delay: idx * 0.2 + 0.5, type: "spring" },
